...
const RegisterPortal = () => {
  ...
  return ReactDom.createPortal(
    <section className='flex-center'>
      ...
      ></div>
      <div
        className='custom-scrollbar fixed top-1/7 z-100 bg-white md:w-[460px] h-[500px] overflow-y-auto sm:w-[60%] w-[80%] rounded-md py-3.5 px-5'
        role='dialog'
        aria-modal='true'
      >
        <div
